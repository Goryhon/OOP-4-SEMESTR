...
[the dummy guide](Desktop/ООП Марат/modules/tests/googleteststs/googletest/docs/gmock_for_dummies.md) first to make sure you understand the
basics.
...
[Multi-argument Matchers](Desktop/ООП Марат/googletestference/matchers.md#MultiArgMatchers) for the
complete list.
...
See [`EXPECT_THAT`](Desktop/ООП Марат/googletestference/assertions.md#EXPECT_THAT) in the Assertions
Reference.

### Using Predicates as Matchers

gMock provides a set of built-in matchers for matching arguments with expected
values—see the [Matchers Reference](Desktop/ООП Марат/googletestference/matchers.md) for more information.
...
[`After` clause](Desktop/ООП Марат/googletestference/mocking.md#EXPECT_CALL.After) of `EXPECT_CALL`.
...
If the [built-in set](Desktop/ООП Марат/googletestock_cheat_sheet.md#CardinalityList) of cardinalities
...
[The GoogleTest advanced guide](Desktop/ООП Марат/googletestvanced.md#teaching-googletest-how-to-print-your-values)
