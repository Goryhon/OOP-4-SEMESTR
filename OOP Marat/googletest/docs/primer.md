...
the [`ASSERT_EQ` and `EXPECT_EQ`](Desktop/ООП Марат/googletestference/assertions.md#EXPECT_EQ) macros to
...
provided by GoogleTest, see the [Assertions Reference](Desktop/ООП Марат/googletestference/assertions.md).
...
4.  If necessary, write a destructor or `TearDown()` function to release any
    ...
    the [FAQ](Desktop/ООП Марат/googletestq.md#CtorVsSetUp).
...
> [death tests](Desktop/ООП Марат/googletestvanced.md#death-tests)) and thus is not supported.
...
[AdvancedGuide](Desktop/ООП Марат/googletestvanced.md). You **must** call this function before calling
