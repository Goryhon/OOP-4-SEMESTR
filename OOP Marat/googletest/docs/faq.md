...
[the `DISABLED_` prefix](Desktop/ООП Марат/googletestvanced.md#temporarily-disabling-tests), in addition
...
[here](Desktop/ООП Марат/googletestvanced.md#assertion-placement).

## My death test hangs (or seg-faults). How do I fix it?

In googletest, death tests are run in a child process and the way they work is
delicate. To write death tests you really need to understand how they work—see
the details at [Death Assertions](Desktop/ООП Марат/googletestference/assertions.md#death) in the
...
See details for [`EXPECT_PRED*`](Desktop/ООП Марат/googletestference/assertions.md#EXPECT_PRED) in the
Assertions Reference.
...
[section](Desktop/ООП Марат/googletestvanced.md#assertion-placement) in the user's guide explains it.
