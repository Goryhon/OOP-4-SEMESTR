...
Creates an [expectation](Desktop/ООП Марат/googletestock_for_dummies.md#setting-expectations) that the
...
[matchers](Desktop/ООП Марат/googletestock_for_dummies.md#matchers-what-arguments-do-we-expect) that
...
each argument's matcher were a [wildcard matcher (`_`)](Desktop/ООП Марат/googletestference/matchers.md#wildcard).
See the [Matchers Reference](Desktop/ООП Марат/googletestference/matchers.md) for a list of all built-in matchers.
...
matcher above. See [Multi-argument Matchers](Desktop/ООП Марат/googletestference/matchers.md#MultiArgMatchers).
...
[action](Desktop/ООП Марат/googletestock_for_dummies.md#actions-what-should-it-do) that the function
call will perform. See the [Actions Reference](Desktop/ООП Марат/googletestference/actions.md) for a list of
built-in actions.
...
[uninteresting calls](Desktop/ООП Марат/googletestock_cook_book.md#uninteresting-vs-unexpected). The
