...
[Assertion Placement](Desktop/ООП Марат/googletestvanced.md#assertion-placement) for more information.
...
The following assertion allows [matchers](Desktop/ООП Марат/googletestference/matchers.md) to be used to verify
values.
...
Verifies that *`value`* matches the [matcher](Desktop/ООП Марат/googletestference/matchers.md) *`matcher`*.
...
[Matchers Reference](Desktop/ООП Марат/googletestference/matchers.md). It is also possible to write your own
matchers—see [Writing New Matchers Quickly](Desktop/ООП Марат/googletestock_cook_book.md#NewMatchers).
...
[Teaching GoogleTest How to Print Your Values](Desktop/ООП Марат/googletestvanced.md#teaching-googletest-how-to-print-your-values).
...
[Using a Function That Returns an AssertionResult](Desktop/ООП Марат/googletestvanced.md#using-a-function-that-returns-an-assertionresult).
...
terminate. For context, see [Death Tests](Desktop/ООП Марат/googletestvanced.md#death-tests).
...
The parameter *`matcher`* is either a [matcher](Desktop/ООП Марат/googletestference/matchers.md) for a `const
std::string&`, or a regular expression (see
[Regular Expression Syntax](Desktop/ООП Марат/googletestvanced.md#regular-expression-syntax))—a bare
string *`s`* (with no matcher) is treated as
[`ContainsRegex(s)`](Desktop/ООП Марат/googletestference/matchers.md#string-matchers), **not**
[`Eq(s)`](Desktop/ООП Марат/googletestference/matchers.md#generic-comparison).
