...
[Assertions](Desktop/ООП Марат/googletestference/assertions.md) used within the test body determine the outcome of
the test.
...
[Test Fixtures](Desktop/ООП Марат/googletestimer.md#same-data-multiple-tests).
...
[Value-Parameterized Tests](Desktop/ООП Марат/googletestvanced.md#value-parameterized-tests).
...
[Typed Tests](Desktop/ООП Марат/googletestvanced.md#typed-tests) for more information.
...
For more information, see [Typed Tests](Desktop/ООП Марат/googletestvanced.md#typed-tests).
...
[Type-Parameterized Tests](Desktop/ООП Марат/googletestvanced.md#type-parameterized-tests) for more
information.
...
For more information, see
[Type-Parameterized Tests](Desktop/ООП Марат/googletestvanced.md#type-parameterized-tests).
...
See [Testing Private Code](Desktop/ООП Марат/googletestvanced.md#testing-private-code) for more
information.
...
For more information, see
[Adding Traces to Assertions](Desktop/ООП Марат/googletestvanced.md#adding-traces-to-assertions).
...
See [Skipping Test Execution](Desktop/ООП Марат/googletestvanced.md#skipping-test-execution) for more
information.
...
[Global Set-Up and Tear-Down](Desktop/ООП Марат/googletestvanced.md#global-set-up-and-tear-down).
...
type-parameterized test suite. See [Typed Tests](Desktop/ООП Марат/googletestvanced.md#typed-tests) and
[Type-Parameterized Tests](Desktop/ООП Марат/googletestvanced.md#type-parameterized-tests).
...
Returns the name of the parameter type, or `NULL` if this is not a typed or
type-parameterized test. See [Typed Tests](Desktop/ООП Марат/googletestvanced.md#typed-tests) and
[Type-Parameterized Tests](Desktop/ООП Марат/googletestvanced.md#type-parameterized-tests).
...
[Running a Subset of the Tests](Desktop/ООП Марат/googletestvanced.md#running-a-subset-of-the-tests)
...
See [Typed Tests](Desktop/ООП Марат/googletestvanced.md#typed-tests) and
[Type-Parameterized Tests](Desktop/ООП Марат/googletestvanced.md#type-parameterized-tests) for more
information.
...
[Global Set-Up and Tear-Down](Desktop/ООП Марат/googletestvanced.md#global-set-up-and-tear-down) for
more information.
...
See
[Registering tests programmatically](Desktop/ООП Марат/googletestvanced.md#registering-tests-programmatically)
for more information.
...
See [Type Assertions](Desktop/ООП Марат/googletestvanced.md#type-assertions) for more information.
...
[Specifying Names for Value-Parameterized Test Parameters](Desktop/ООП Марат/googletestvanced.md#specifying-names-for-value-parameterized-test-parameters)
for more information.
