...
Now that you have read the [googletest Primer](Desktop/ООП Марат/modules/tests/googleteststs/googletest/docs/primer.md) and learned how to
...
See [Explicit Success and Failure](Desktop/ООП Марат/googletestference/assertions.md#success-failure) in
the Assertions Reference.

### Exception Assertions

See [Exception Assertions](Desktop/ООП Марат/googletestference/assertions.md#exceptions) in the Assertions
Reference.
...
[`EXPECT_PRED*`](Desktop/ООП Марат/googletestference/assertions.md#EXPECT_PRED) in the Assertions
...
[`EXPECT_PRED*`](Desktop/ООП Марат/googletestference/assertions.md#EXPECT_PRED) and
[`EXPECT_TRUE`](Desktop/ООП Марат/googletestference/assertions.md#EXPECT_TRUE) unsatisfactory, or some
...
[`EXPECT_PRED_FORMAT*`](Desktop/ООП Марат/googletestference/assertions.md#EXPECT_PRED_FORMAT) in the
Assertions Reference for details.

### Floating-Point Comparison

See [Floating-Point Comparison](Desktop/ООП Марат/googletestference/assertions.md#floating-point) in the
...
[`EXPECT_PRED_FORMAT2`](Desktop/ООП Марат/googletestference/assertions.md#EXPECT_PRED_FORMAT), for
example:
...
You can use the gMock [string matchers](Desktop/ООП Марат/googletestference/matchers.md#string-matchers)
with [`EXPECT_THAT`](Desktop/ООП Марат/googletestference/assertions.md#EXPECT_THAT) to do more string
...
See [Windows HRESULT Assertions](Desktop/ООП Марат/googletestference/assertions.md#HRESULT) in the
Assertions Reference.
...
[constructor/destructor vs. `SetUp`/`TearDown`](Desktop/ООП Марат/googletestq.md#CtorVsSetUp)
...
[Death Assertions](Desktop/ООП Марат/googletestference/assertions.md#death) in the Assertions Reference
for details.
...
See [Death Assertions](Desktop/ООП Марат/googletestference/assertions.md#death) in the Assertions
Reference.
...
[a custom GMock matcher](Desktop/ООП Марат/googletestock_cook_book.md#NewMatchers) instead. This lets you
...
[`INSTANTIATE_TEST_SUITE_P`](Desktop/ООП Марат/googletestference/testing.md#INSTANTIATE_TEST_SUITE_P) in
...
[`Values`](Desktop/ООП Марат/googletestference/testing.md#param-generators) parameter generator:
...
[parameter generator](Desktop/ООП Марат/googletestference/testing.md#param-generators).
...
[`ValuesIn`](Desktop/ООП Марат/googletestference/testing.md#param-generators) parameter generator:
...
[should not contain underscores](Desktop/ООП Марат/googletestq.md#why-should-test-suite-names-and-test-names-not-contain-underscore)
...
[`TestInfo`](Desktop/ООП Марат/googletestference/testing.md#TestInfo) class has this information.

To obtain a `TestInfo` object for the currently running test, call
`current_test_info()` on the [`UnitTest`](Desktop/ООП Марат/googletestference/testing.md#UnitTest)
singleton object:
...
[`testing::TestEventListener`](Desktop/ООП Марат/googletestference/testing.md#TestEventListener) or
[`testing::EmptyTestEventListener`](Desktop/ООП Марат/googletestference/testing.md#EmptyTestEventListener)
...
[`TestEventListeners`](Desktop/ООП Марат/googletestference/testing.md#TestEventListeners) - note the "s"
